...
class Converter:
    ...
    def __init__(self):
        ...
        self.temp_heading = Label(self.temp_frame,
                                  text="Minecraft Mob Quiz",
                                  font=("Arial", "16", "bold")
                                  )
        self.temp_heading.grid(row=0)

        instructions = "name every minecraft mob," \
        ...
        error = "sorry that isnt one of the mobs"
        ...
        self.to_delete_button = Button(self.button_frame,
                                        text="delete",
                                        bg="#990099",
                                        fg=button_fg,
                                        font=button_font, width=12,
                                        command=lambda: self.temp_convert(-459))
        self.to_delete_button.grid(row=0, column=0, padx=5, pady=5)

        self.to_submit_button = Button(self.button_frame,
                                          text="submit",
                                          bg="#009900",
                                          fg=button_fg,
                                          font=button_font, width=12,
                                          command=lambda: self.temp_convert(-273))
        self.to_submit_button.grid(row=0, column=1, padx=5, pady=5)
    ...
    def check_temp(self, min_value):
        ...
        has_error = "no"
        error = "please enter name of a minecraft mob"
