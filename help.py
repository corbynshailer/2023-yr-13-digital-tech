...
class QuizApp(tk.Tk):
    ...
    def display_help(self):
        ...
        help_text += "5. You can click the 'History' button to view your previous answers.\n"
        help_text += "6. Click the 'Export' button to export the statistics of your answers.\n"
